            ...
            <Router history={history}>
                <div>
                    ...
                    <Switch>
                        ...
                        <Route path= {`${RESET_PASSWORD_PAGE_LINK}`} exact component={ResetPasswordComponent} />
